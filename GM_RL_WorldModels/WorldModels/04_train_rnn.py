...
if __name__ == "__main__":
		...
		parser.add_argument('--steps', default = 100, help='how many rnn batches to train over')
		parser.add_argument('--batch_size', default = 32, help='how many episodes in a batch?')
