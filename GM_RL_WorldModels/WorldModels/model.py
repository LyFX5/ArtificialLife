...
def main(args): #args
  ...
  '''
  my_number_of_episodes = 1
  
  env_name = 'car_racing' #args.env_name
  filename = '/home/eduard/Desktop/GitProjects/GM_RL_WorldModels/WorldModels/controller/car_racing.cma.4.4.best.json' #args.filename
  the_seed = 111 #args.seed
  final_mode = False #args.final_mode
  generate_data_mode = False #args.generate_data_mode
  dream_mode = False #args.dream_mode
  render_mode = True #args.render_mode
  record_video = True #args.record_video
  max_length = 200 #args.max_length
  '''
